 ...
 */
class FormViewHelper extends RenderViewHelper
{
    ...
    public function render()
    {
        ...
        foreach ($items as $item) {
            ...
            if (is_array($item) && isset($item['partial'])) {
                ...
                $result .= htmlspecialchars_decode($renderViewHelper->render($section, $partial, $arguments));
     ...
     * @return boolean
     */
    static protected function isAssociativeArray($array)
    {
